...
pub fn read_write_2mb_sync(file_dir: Arc<PathBuf>, index: usize) {
    read_write_Xkb_sync(file_dir, index, 2000);
}

pub fn read_write_2mb_nosync(file_dir: Arc<PathBuf>, index: usize) {
    read_write_Xkb_nosync(file_dir, index, 2000);
}
